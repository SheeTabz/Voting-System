                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li>
                                            <a data-toggle="collapse" data-target="#demo" href="vie.php">Vie <span class="admin-project-icon nalika-icon nalika"></span></a>
                                        </li>
                                        <li>
                                            <a data-toggle="collapse" data-target="#others" href="vote.php">Vote <span class="admin-project-icon nalika-icon nalika"></span></a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
